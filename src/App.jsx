    ...
    <div className="icon-cluster">
      ...
      >
        <CIcon
          size={centre.size}
          style={{
            filter: `drop-shadow(0 0 8px ${centre.color}) drop-shadow(0 0 16px ${centre.color})`,
          }}
        />
      </div>
    </div>
...
const SOCIALS = [
  ...
  },
  {
    name: "LinkedIn",
    Icon: Linkedin,
    url: "https://linkedin.com/in/saurabh-kumar-255911288/",
    color: "#00e5ff",
  },
  {
    name: "LeetCode",
...
const PROJECTS = [
  {
    ...
    sub: "MERN Stack · Railway Platform",
    desc: "A comprehensive railway ticket exchange platform enabling users to list, discover, and purchase unused train tickets. Features JWT authentication, OTP-based email verification, geo-based smart search using the Haversine formula, station autosuggestions, and automated expired listing cleanup through cron jobs.",
    icon: <Train size={18} />,
    tags: ["MongoDB", "Express.js", "React", "Node.js", "GeoJSON", "JWT"],
...

  {
    num: "02",
    year: "May 2026",
    title: "Hotel Frontier",
    sub: "MERN Stack · Hotel Reservation Platform",
    desc: "A full-stack hotel booking platform with OTP-based email authentication, protected user sessions, role-based admin dashboard, reservation management, real-time check-in/check-out operations, automated email notifications using Google Apps Script, and scheduled cleanup jobs powered by node-cron.",
    ...
    live: "https://hotelfrontier.vercel.app/",
    repo: "https://github.com/Saurabh90262/Hotel-App",
    accent: "#00f0ff",
  },

  {
    ...
    year: "Nov 2025",
    title: "Photon AI GPT",
    sub: "Gemini API · AI Chatbot",
    desc: "An AI-powered chatbot built using Google Gemini API for intelligent and contextual conversations. Features real-time message streaming, persistent chat history, markdown rendering, theme switching, and a responsive user interface for an enhanced chat experience.",
    icon: <Bot size={18} />,
    tags: ["JavaScript", "Gemini API", "AI", "Markdown", "Responsive UI"],
    live: "https://photon-ai.netlify.app/",
    repo: "https://github.com/Saurabh90262/PhotonAI-GPT",
    accent: "#ff00a0",
  },

  {
    ...
    desc: "High-accuracy ML engine that decodes true market value of used cars. Benchmarked Linear Regression, Random Forest, SVR, and XGBoost models to deliver precise resale value predictions with minimal error margins.",
    icon: <Car size={18} />,
...

  {
    ...
    sub: "Live Data · Weather Forecasting",
    desc: "A weather forecasting application providing real-time weather updates for locations worldwide. Displays temperature, humidity, wind speed, and forecast data through a clean, responsive, and user-friendly interface.",
    icon: <Wind size={18} />,
...

  {
    ...
    desc: "A lightweight QR code generation platform that instantly converts text and URLs into high-quality QR codes. Built with third-party API integration and a responsive interface for seamless user experience.",
    icon: <QrCode size={18} />,
...
const ACHIEVEMENTS = [
  {
    ...
    sub: "Algorithmic mastery, one submission at a time.",
    Icon: LeetCodeIcon,
    accent: "#ffe600",
  },
  {
    num: "155+",
    label: "GFG Problems",
    sub: "Spanning the full DSA spectrum.",
    Icon: GFGIcon,
    accent: "#00ff66",
  },
  {
    num: "★",
    label: "Pandas Badge",
    sub: "LeetCode — data analysis proficiency certified.",
    Icon: Award,
    accent: "#ff00a0",
  },
];
...
const Wrap = ({ children, style }) => (
  <div
    ...
    style={{ maxWidth: 1080, margin: "0 auto", padding: "0 32px", ...style }}
  >
    {children}
  </div>
);
const Sec = ({ id, children, style }) => (
  <section
    ...
    style={{ padding: "96px 0", position: "relative", ...style }}
  >
    {children}
  </section>
);
    ...
    >
      ...
      >
        <a href="#home" style={{ textDecoration: "none", flexShrink: 0 }}>
          <span
            className="display"
            style={{ fontSize: 26, color: "var(--white)", letterSpacing: 2 }}
          >
            SK
          </span>
        ...
        {!isMobileNav && (
          <div style={{ display: "flex", gap: 2, alignItems: "center" }}>
            {NAV_ITEMS.map((n) => (
              <a key={n} href={`#${n.toLowerCase()}`} className="npill">
                {n}
              </a>
            ))}
          </div>
        ...
        {!isMobileNav && (
          <button
            ...
            className="btn-y"
            style={{ padding: "8px 18px", fontSize: 11, flexShrink: 0 }}
          >
...
// ─── HERO ─────────────────────────────────────────────────────────────────
const Hero = () => {
  const pInit = useCallback(async (e) => {
    await loadFull(e);
  }, []);
    ...
    >
      ...
      <div
        ...
        style={{
          ...
          height: 550,
          background:
            "radial-gradient(circle,rgba(0,240,255,0.055) 0%,transparent 70%)",
          filter: "blur(50px)",
          pointerEvents: "none",
        }}
      />
      <div
        ...
        style={{
          ...
          height: 400,
          background:
            "radial-gradient(circle,rgba(255,0,160,0.04) 0%,transparent 70%)",
          filter: "blur(40px)",
          pointerEvents: "none",
          animationDelay: "4s",
        }}
        ...
        >
          ...
          <div>
            ...
            <motion.h1
              ...
              className="display gw"
              data-text="SAURABH KUMAR"
              style={{
            ...
            >
              ...
              <span
                style={{
                  color: "var(--accent)",
                  textShadow: "0 0 80px rgba(0,240,255,0.35)",
                }}
              >
                KUMAR
              </span>
            ...
            >
              Full-stack architect and ML enthusiast. Building digital systems
              that bridge elegant theory with real-world impact. B.Tech IT at
            ...
            >
              <a href="#projects" className="btn-y">
          ...
          >
            <motion.div
              ...
              style={{
                ...
                borderRadius: "50%",
                background:
                  "conic-gradient(from 0deg,var(--accent),transparent 40%,var(--accent2),transparent 80%,var(--accent3))",
                filter: "blur(5px)",
                opacity: 0.65,
              }}
            />
    ...
    <Wrap>
      ...
      >
        ...
        >
          ...
          >
            I'm a dedicated IT student at{" "}
            <span style={{ color: "var(--white)" }}>
              ABES Engineering College
            </span>
            , obsessively building things that work elegantly, efficiently, and
            at scale.
          </p>
          <p
            style={{
          ...
          >
            From low-level DSA mastery to deploying ML models and designing
            full-stack products — I debug Java at midnight with the same energy
            I bring to pixel-perfect UI at noon.
          </p>
          <Tilt>
        ...
        <motion.div
          ...
          transition={{ duration: 0.6 }}
        >
          <span className="slabel" style={{ marginBottom: 24 }}>
            CORE EXPERTISE
          </span>
          ...
          <Tilt key={g.label}>
            ...
            >
              ...
              >
                <span
                  className="slabel"
                  style={{ fontSize: 9, marginBottom: 0, paddingTop: 6 }}
                >
                  {g.label}
                </span>
...
const PCard = ({ p }) => (
  <Tilt>
    <motion.div
      className="card rot-border pcard-wrap"
      whileHover={{ y: -6 }}
    ...
    >
      <div
        style={{
          ...
          height: 130,
          borderRadius: "50%",
          background: `radial-gradient(circle,${p.accent}18,transparent 70%)`,
          filter: "blur(18px)",
          pointerEvents: "none",
        }}
      />
          ...
          <div style={{ position: "relative", paddingLeft: 28 }}>
            ...
            <div
              style={{
                ...
                width: 2,
                background:
                  "linear-gradient(to bottom,transparent,var(--accent) 10%,var(--accent2) 50%,var(--accent3) 90%,transparent)",
                borderRadius: 2,
                pointerEvents: "none",
              }}
            />
            ...
            {PROJECTS.map((p, i) => (
              <motion.div
                ...
                style={{
                  position: "relative",
                  marginBottom: i < PROJECTS.length - 1 ? 36 : 0,
                }}
              >
                {/* Dot on rail */}
                <motion.div
                  ...
                  style={{
                    ...
                    boxShadow: `0 0 12px ${p.accent}99`,
                    zIndex: 2,
                    flexShrink: 0,
                  }}
                />
          ...
          <div style={{ position: "relative" }}>
            <div
              style={{
                ...
                width: 1,
                background:
                  "linear-gradient(to bottom,transparent,var(--accent) 15%,var(--accent2) 50%,var(--accent3) 85%,transparent)",
              ...
              return (
                <motion.div
                  ...
                  style={{
                    ...
                    alignItems: "center",
                    marginBottom: i < PROJECTS.length - 1 ? 64 : 0,
                  }}
                >
                  <div
                    style={{
                  ...
                  <div style={{ display: "flex", justifyContent: "center" }}>
                    <motion.div
                      ...
                      style={{
                        ...
                        boxShadow: `0 0 20px ${p.accent}88,0 0 50px ${p.accent}30`,
                        position: "relative",
                        zIndex: 2,
                        flexShrink: 0,
                      }}
    ...
    <Wrap>
      ...
      >
        ...
        >
          ...
          >
            Open to opportunities, collaborations, and conversations that spark
            something new. My inbox is always open.
          </p>
          <a
...
const Footer = () => (
  ...
  >
    ...
    >
      ...
      >
        Built with <span style={{ color: "#ff00a0" }}>❤️</span> by{" "}
        <span style={{ color: "#eef0f9" }}>Saurabh (Sashi)</span> using React &
        Three.js
      </p>
      <div
        style={{
